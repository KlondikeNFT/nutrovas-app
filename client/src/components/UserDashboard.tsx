...
const UserDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col" onClick={handleClickOutside}>
      {/* Top Bar */}
      <div className="bg-gray-800 border-b border-gray-700 px-4 sm:px-6 py-4 flex-shrink-0">
        <div className="flex items-center justify-between">
          {/* Left side - Welcome */}
          <div className="flex items-center flex-1 min-w-0">
            <h1 className="text-sm sm:text-lg font-medium text-gray-200 truncate">
              ...
              <div className="absolute right-0 mt-2 w-64 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50">
                ...
                <div className="py-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center px-4 py-3 text-red-400 hover:bg-gray-700 hover:text-red-300 transition-colors"
                  >
                    <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="px-4 sm:px-6 py-6 flex-shrink-0">
        <div className="mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <button
              ...
              className="bg-gray-800 border border-gray-700 rounded-lg p-4 hover:bg-gray-700 transition-colors text-left w-full"
            >
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-200 font-medium text-sm sm:text-base">Log new intake</span>
            ...
            {/* My Pantry Card */}
            <Link to="/pantry" className="bg-gray-800 border border-gray-700 rounded-lg p-4 hover:bg-gray-700 transition-colors text-left w-full">
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-200 font-medium text-sm sm:text-base">My pantry</span>
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                </svg>
              </div>
              <div className="text-2xl sm:text-3xl font-bold text-purple-400 text-left">0</div>
            </Link>

            {/* Calendar Card */}
            <Link to="/tracker" className="bg-gray-800 border border-gray-700 rounded-lg p-4 hover:bg-gray-700 transition-colors text-left w-full">
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-200 font-medium text-sm sm:text-base">Calendar</span>
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              <div className="text-2xl sm:text-3xl font-bold text-orange-400 text-left">📅</div>
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 px-6 py-4 relative">
        ...
        {showSuggestions && (
          <div className="absolute bottom-20 left-4 right-4 sm:left-6 sm:right-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <button
                onClick={() => handleSuggestionClick("Help me find a new supplement")}
                className="bg-gray-800 border border-gray-700 rounded-lg p-3 hover:bg-gray-700 transition-colors text-left shadow-lg w-full"
              >
        ...
        <div className="absolute bottom-4 left-4 right-4 sm:left-6 sm:right-6">
          <form onSubmit={handleChatSubmit} className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-lg text-base"
            />
            <button
              type="submit"
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors shadow-lg text-base min-h-[44px]"
            >
              Send
            </button>
          </form>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-4 sm:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg sm:text-xl font-bold text-gray-100">Log New Supplement Intake</h2>
              <button
                onClick={() => setShowLogForm(false)}
                className="text-gray-400 hover:text-gray-200 p-2 rounded-lg hover:bg-gray-700 transition-colors min-h-[44px] min-w-[44px]"
              >
            ...
            <form onSubmit={handleLogFormSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[44px] text-base"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[44px] text-base"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={3}
                  className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none min-h-[44px] text-base"
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                <button
                  type="button"
                  onClick={() => setShowLogForm(false)}
                  className="flex-1 bg-gray-600 hover:bg-gray-700 text-gray-200 px-4 py-3 rounded-lg font-medium transition-colors min-h-[44px] text-base"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg font-medium transition-colors min-h-[44px] text-base"
                >
                  Log Intake
                </button>
              </div>
